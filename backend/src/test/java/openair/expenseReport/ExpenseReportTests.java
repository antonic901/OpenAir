...
public class ExpenseReportTests {
    ...
    public void testAddReport(){
        ...
        ExspenseReportDTO expenseReportDTO1 = openair.expenseReport.TestData.createReportDTO();
        ExspenseReportDTO expenseReportDTO2 = openair.expenseReport.TestData.createReportDTO();
        expenseReportDTO2.setProjectId(2L);

        //when
        when(projectRepository.findById(1L)).thenReturn(Optional.of(openair.project.TestData.createProject()));
    ...
    public void reviewReport(){
        //given
        ExpenseReport expenseReport = TestData.createReport();
        ExpenseReport expenseReport1 = TestData.createReport();
        ...
        when(expenseReportRepository.save(any(ExpenseReport.class))).thenReturn(new ExpenseReport());
        when(employeeRepository.save(any(Employee.class))).thenReturn(openair.employee.TestData.createEmployee());
