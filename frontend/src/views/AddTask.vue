...
export default {
    ...
    methods: {
        getEmployee() {
            this.axios.get("/projects/" + this.selectedProject.id + "/employees",{headers: {'Authorization': `Bearer ` + localStorage.jws}})
                .then(r => {
        ...
        assign() {
            ...
            this.axios.post("/tasks", add ,{headers: {'Authorization': `Bearer ` + localStorage.jws}})
                .then(() => {
                    this.e1 = 5;
                    this.name = '';
                })
